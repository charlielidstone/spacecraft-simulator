...
I decided not to use a while game engine for this, so instead I'm using [SFML](https://www.sfml-dev.org/) which is a low level library to open windows and whatnot.
